...
foreach ($ssa_appointment_types as $appointment_type_key => $appointment_type) {
  ...
  if ( ! empty( $_GET['suggest_first_available'] ) ) {
    $ssa_appointment_types[$appointment_type_key]['suggest_first_available'] = filter_var( esc_attr( $_GET['suggest_first_available'] ), FILTER_VALIDATE_BOOLEAN );
  }
  if ( ! empty( $_GET['suggest_first_available_within_minutes'] ) ) {
    $ssa_appointment_types[$appointment_type_key]['suggest_first_available_within_minutes'] = (int) esc_attr( $_GET['suggest_first_available_within_minutes'] );
  }
}
